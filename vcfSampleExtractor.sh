...
Help()
{
	...
	echo 
	echo "Usage:"
	echo '	sbatch --job-name=[jobName] /path/to/vcfSampleExtractor.sh [sample] [inputVcf] [filterExpression]'
	echo 
	...
	echo 
	echo "Usage Example:"
	echo "	sbatch --job-name=test ~/subscriptr/vcfSampleExtractor.sh sample1 /gpfs/scratch/username/input.vcf ""'"'GT="'"0|0"'"'"'"
	echo 
}
